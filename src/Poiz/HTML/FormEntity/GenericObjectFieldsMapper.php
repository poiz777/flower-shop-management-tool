<?php
	...
	trait GenericObjectFieldsMapper {
		...
		public static function getClientOptions(){
			/**@var \App\Poiz\Biller\Entity\Client $client */
			/**@var \App\Poiz\Biller\Entity\Contact $clientContact */
		...
		public static function getProjectsOptions(){
			/**@var \App\Poiz\Biller\Entity\Project $project */
			/**@var \App\Poiz\Biller\Entity\Contact $projectContact */
			$eMan           = app('Doctrine\ORM\EntityManagerInterface');
