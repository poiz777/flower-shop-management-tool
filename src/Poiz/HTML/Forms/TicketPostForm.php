<?php
	...
	class TicketPostForm {
		 ...
		 * @param array                                      $config
		 */
		public function __construct($formEntity=null, ?ShopTranslator $translator=null, $injectScripts=true, $config=[]) {
			$this->translator   = $translator;
			$this->formEntity   = $formEntity ? $formEntity : new TicketPostEntity();
			$setValue           = $formEntity ? true : false;
			$this->setup( $setValue, $injectScripts, $config );
		}
		
		public function getForm(){
			return $this->elements;
		}
		public function setup($setValue=false, $injectScripts=true, $rayConfig = []) {
			/**  @var  Widget $element */
