<?php
	...
	class TicketManagementForm {
		...
		public function __construct($formEntity=null, ?ShopTranslator $translator=null, $injectScripts=true) {
			...
			$this->formEntity   = $formEntity ? $formEntity : new TicketManagementEntity();
		 ...
		 *
		 * @return TicketManagementForm
		 */
		public function setElements( array $elements ): TicketManagementForm {
		 ...
		 * @return TicketManagementForm
		 */
		public function setWidgetMetaData( array $widgetMetaData ): TicketManagementForm {
