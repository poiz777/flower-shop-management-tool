<?php 
	...
	/**
	 * TicketManagementEntity
	 **/
	class TicketManagementEntity {
		 ...
		 * --FormInputOptions App\Forms\TicketManagementEntity::fetchMelanieFlowerShops
		 ...
		 * ##FormInputOptions App\Forms\TicketManagementEntity::fetchTicketTypesAsOptions
		 * ##FormValidationStrategy NUM 
		 * ##FormInputEntityClass App\Poiz\HTML\Widgets\FormElements\DropDownEnhanced
		 */
		 ...
		 * --FormInputOptions App\Forms\TicketManagementEntity::fetchTicketYesNoOptions
		 * --FormValidationStrategy MISC
		 * --FormInputEntityClass App\Poiz\HTML\Widgets\FormElements\DropDownEnhanced
		 */
		 ...
		 * --FormInputOptions App\Forms\TicketManagementEntity::fetchTicketPrioritiesAsOptions
		 * --FormValidationStrategy NUM
		 * --FormInputEntityClass App\Poiz\HTML\Widgets\FormElements\DropDownEnhanced
		 */
		 ...
		 * ##FormInputOptions App\Forms\TicketManagementEntity::fetchTicketStatusAsOptions
		 * ##FormValidationStrategy NUM 
		 * ##FormInputEntityClass App\Poiz\HTML\Widgets\FormElements\DropDownEnhanced
		 */
		...
		/**
		 * @var \App\Forms\TicketManagementEntity
		 */
		 ...
		 *
		 * @return TicketManagementEntity
		 */
		public function setTicketOpener( $ticket_opener ): TicketManagementEntity {
		 ...
		 * @return TicketManagementEntity
		 */
		public function setBusinessClient($businessClient ): TicketManagementEntity {
		 ...
		 * @return TicketManagementEntity
		 */
		public function setPrivateClient($privateClient ): TicketManagementEntity {
		 ...
		 * @return TicketManagementEntity
		 */
		public function setTicketeintragEintrag( $ticketeintrag_eintrag ): TicketManagementEntity {
